...
def query():
    ...
    for subdomain in subdomains_list:
        try:
            ...
            print (termcolor.colored("[!] stoped by user !",color="red"))
            quit()
try:
    query()
except:
